...
//        System.out.println(blobClient.getBlobUrl());
    ...
    public String uploadImage(MultipartFile file,String path) {
        // 獲取 Blob 容器的引用
        BlobContainerClient containerClient = blobServiceClient.getBlobContainerClient("images/chats/"+path);
        // 獲取 Blob 的引用
        BlobClient blobClient = containerClient.getBlobClient(file.getOriginalFilename());
        try {
            // 上傳文件到 Blob
...
//        System.out.println(blobClient.getBlobUrl());
    ...
    public String uploadEmpImage(MultipartFile file,Integer empId) {
        // 獲取 Blob 容器的引用
        BlobContainerClient containerClient = blobServiceClient.getBlobContainerClient("images/emp/"+empId);
        // 獲取 Blob 的引用
        BlobClient blobClient = containerClient.getBlobClient(file.getOriginalFilename());
        try {
            // 上傳文件到 Blob
